  ...
  // random numbers and find out the probability of getting any of the six faces using histogram!
  ...
  TH1F *h6 = new TH1F("h6", "Face_6", 9, -1, 7);
	...
	out<<"face:"<<" face1"<<"\t"<<"face2"<<"\t"<<"face3"<<"\t"<<"face4"<<"\t"<<"face5"<<"\t"<<"face6"<<endl;
	     ...
	     float x = r.Uniform(0, 1);
	     	...
	     	if (x < 1./9.)                      {face1++; T1++;}
	     	if (x > 1./9. && x < 2./9.)         {face2++; T2++;}
	     	if (x > 2./9. && x < 3./9.)         {face2++; T2++;}
	     	if (x > 3./9. && x < 4./9.)         {face3++; T3++;}
	     	if (x > 4./9. && x < 5./9.)         {face4++; T4++;}
	     	if (x > 5./9. && x < 6./9.)         {face4++; T4++;}
	     	if (x > 6./9. && x < 7./9.)         {face5++; T5++;}
	     	if (x > 7./9. && x < 8./9.)         {face6++; T6++;}
	     	if (x > 8./9.)                      {face6++; T6++;}
  ...
  TCanvas *c1 = new TCanvas("c1", "Unfair Dice Distribution in 60000 rolls", 100, 10, 600, 600);
  c1->SetGrid();
